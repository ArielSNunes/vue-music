    ...
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        ...
        <button type="button" class="z-50 h-24 w-24 text-3xl bg-white text-black rounded-full focus:outline-none"
          ...
          <i class="fas" :class="isPlaying && playingSong.docID == this.$route.params.id ? 'fa-pause' : 'fa-play'"></i>
        </button>
      ...
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        <div class="px-6 pt-6 pb-5 font-bold border-b border-gray-200">
          ...
          <span class="card-title">
            {{ $tc('pages.song.commentCount', song.commentCount, { count: song.commentCount }) }}
          </span>
        ...
        <div class="p-6">
          ...
          <vee-form :validation-schema="schema" @submit="addComment" v-if="userLoggedIn">
            ...
            <button type="submit" :disabled="commentInSubmission"
